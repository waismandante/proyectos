...
# Definir la spider MagypSpiderSpider
class MagypSpiderSpider(scrapy.Spider):
    name = "magyp_spider"
    start_urls = [
        'https://www.magyp.gob.ar/sitio/areas/ss_mercados_agropecuarios/_transporte-emb/granos.php?accion=imp'
    ]
    ...
    def generar_links(self):
        links = []
        base = "https://www.magyp.gob.ar/sitio/areas/ss_mercados_agropecuarios/_transporte-emb/{}_{}/01_gra_pto_mes_{}_{}.php"
